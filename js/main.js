;(function () {
	...
	// Set the date we're counting down to
		var countDownDate = new Date("Jul 23, 2022 14:40:00").getTime();
		...
		// Display the result in an element with id="demo"
		document.getElementById("days").innerHTML = days +" <small>Дни</small>";
		document.getElementById("hours").innerHTML = hours + " <small>Часы</small> ";
		document.getElementById("minutes").innerHTML = minutes + " <small>Минуты</small> ";
		document.getElementById("seconds").innerHTML = seconds + " <small>Секунды</small> ";
